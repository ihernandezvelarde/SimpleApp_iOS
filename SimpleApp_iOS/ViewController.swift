...
class ViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    let imageCharacterList:[String] = ["tanjiro.png", "inosuke.png","zenitsu.png", "nezuko.png", "tengen.png", "rengoku.png","tomioka.png", "shinobu.png", "muzan.png", "akaza.png", "gyutaro.png","daki.png"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let imagenes = self.imageCharacterList[indexPath.row]
        ...
        cell.faceCharacterImage.image = UIImage(named:imagenes)
        cell.attackImage.image = UIImage(named:self.imageOne)
        cell.hpImage.image = UIImage(named:self.imageTwo)
        cell.defenseImage.image = UIImage(named:self.imageThree)
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        character.hp = hpCharacterList
        character.defense = defenseCharacterList
        character.images = imageCharacterList
        character.imageOne = imageOne
        character.imageTwo = imageTwo
        character.imageThree = imageThree
